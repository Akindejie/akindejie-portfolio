                ...
                {data.map((d) => (
                    <div className="container" key={d.id}>
                        <div className="item">
                            ...
                            <div className="right">
                                <img src="https://cdn.dribbble.com/users/3320958/screenshots/15212021/media/b273f408f8c1ad3d535fc34166256b18.png?compress=1&resize=1600x1200" alt="Work Samples" />
                            </div>
                        </div>
                    </div>
                ))};
